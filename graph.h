...
class GraphInterface
{
    ...
    private :
        ...
        //Les widgets qui constitueront ma top Box
        grman::WidgetBox m_ButtonBox; // sera la boite à boutons en bas

        grman::WidgetButton m_Button1; // sera le bouton pour sauvegarder
        ...
        grman::WidgetButton m_Button4; // sera le bouton pour Ajouterun sommet
        grman::WidgetText m_AddVertex; //le texte Ajouter sommet
